...
class _TareasScreenState extends State<TareasScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder(
          future: _databaseHelper.getAllTareasIncompletas(),
          builder: (BuildContext context,
              AsyncSnapshot<List<TareasModel>> snapshot) {
        ...
        floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.pushNamed(context, '/tareascompletadas')
                  .whenComplete(() {
                setState(() {});
              });
            }));
                ...
                child: Column(children: [
                  ...
                  Center(
                    child: Text(
                      ...
                      style: TextStyle(
                          color: (DateTime.now()
                                  .isAfter(DateTime.parse(tarea.fechaEntrega!)))
                              ? Colors.red
                              : Colors.black),
                    ),
                  ),
                      ...
                      showDialog(
                          ...
                          builder: (context) {
                            return AlertDialog(
                              title: Text('Confirmación'),
                              content: Text(
                                  '¿Estas seguro de marcar la tarea como completada?'),
                              actions: [
                                TextButton(
                                    //Si
                                    onPressed: () {
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  AgregarTareaScreen(tarea: tarea),
                            )).then((value) {
                          setState(() {});
                        });
                      },
